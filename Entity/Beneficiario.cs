namespace LC.Web.PadraoSeguros.Entity
{
    ...
    public class Beneficiario : EntityBase, IPersisteableEntity
    {
        ...
        public static IList<Beneficiario> CarregarPorParametro(String nome, String cpf, String rg, SearchMatchType smtype, string matricula = null)
        {
            limpaCPF(ref cpf);
            ...
            if (!String.IsNullOrEmpty(matricula))
            {
                ...
                whereAnd.Append(" (beneficiario_matriculaAssociativa LIKE @beneficiario_matricula OR beneficiario_matriculaFuncional LIKE @beneficiario_matricula)");
                parameterAndValues.Add("@beneficiario_matricula ", "%" + matricula + "%");
            }
