namespace LC.Web.PadraoSeguros.Entity
{
    ...
    public class Contrato : EntityBase, IPersisteableEntity
    {
        ...
        /// <summary>
        /// Dia do mês para novo vencimento
        /// </summary>
        [DBFieldInfo("contrato_vencimentoAlterado", FieldType.Single)]
        public int VencimentoAlterado
        {
            get;
            set;
        }
        ...
        public static DataTable DTCarregarPorOperadoraID_LEGADO(Object operadoraId, String numeroProposta, String benficiarioNome)
        {
            ...
            if (!string.IsNullOrEmpty(numeroProposta))
            {
                ...
                //whereAnd = " AND contrato_numero=@contrato_numero ";
                whereAnd = string.Concat(" AND (contrato_numero='", numeroProposta, "' OR beneficiario_matriculaAssociativa like '%", numeroProposta, "%' or beneficiario_matriculaFuncional like '%", numeroProposta, "%' ) ");
            }
            else
            {
                pnames = new String[1] { "@beneficiario_nome" };
