...
namespace BoletoNet
{
    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        protected static void HtmlOfflineHeader(StringBuilder html)
        {
            ...
            html.Append("<head>");
            html.Append("    <title>Boleto</title>\n");
        ...
        public string MontaHtml(string fileName, string idArquivoCodigoBarras)
        {
            ...
            string fnLogo = "http://ubrasp.iphotel.info/images/boleto/santander/BoletoNet033.jpg"; //fileName + @"BoletoNet" + Utils.FormatCode(_ibanco.Codigo.ToString(), 3) + ".jpg";
            ...
            string fnBarra = caminhoFisico + "BoletoNetBarra.gif";

            string fnCodigoBarras = caminhoFisico + idArquivoCodigoBarras + ".gif"; //System.IO.Path.GetTempFileName();
            C2of5i cb = new C2of5i(Boleto.CodigoBarra.Codigo, 1, 50, Boleto.CodigoBarra.Codigo.Length);
            cb.ToBitmap().Save(fnCodigoBarras);

            //return HtmlOffLine(fnCorte, fnLogo, fnBarra, fnPonto, fnBarraInterna, fnCodigoBarras).ToString();

            string uriCodigoBarras = caminhoVirtual + idArquivoCodigoBarras + ".gif";
            return HtmlOffLine(null, fnLogo, fnBarra, uriCodigoBarras /*fnCodigoBarras*/).ToString();
        }
