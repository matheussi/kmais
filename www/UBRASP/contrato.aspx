<%@ Page EnableEventValidation="false" Theme="Theme" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="false" CodeBehind="contrato.aspx.cs" Inherits="www.UBRASP.contrato" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <cc1:TabContainer BorderStyle="None" BorderWidth="0" Width="100%" ID="tab" runat="server" ActiveTabIndex="0" OnClientActiveTabChanged="ActiveTabChanged">
                ...
                <asp:UpdatePanel runat="server" ID="upDadosComuns" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <table cellpadding="2" width="600" border="0" style="border: solid 1px #507CD1">
                            ...
                            <tr id="Tr1" runat="server" enableviewstate="false" visible="false">
                                <td class="tdPrincipal1">
                                    Plataforma
                                </td>
                                <td class="tdNormal1" colspan="3">
            ...
            <ContentTemplate>
                ...
                <asp:UpdatePanel runat="server" ID="upBeneficiario" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:Panel runat="server" ID="pnlCompraCarencia" EnableViewState="false" Visible="false">
                        <br />
        ...
        <cc1:TabPanel ID="p4" runat="server" Visible="false" EnableViewState="false">
            <HeaderTemplate>
                            ...
                            <tr>
                                ...
                                <td class="tdNormal1">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:DropDownList BackColor="lightgray" Width="107px" runat="server" CssClass="textbox"
        ...
        <cc1:TabPanel ID="p5" runat="server" Visible="false" EnableViewState="false">
            <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="Forma Pagto." HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <asp:DropDownList SkinID="dropdownSkin" ID="cboFormaPagtoAdicional" runat="server" SelectedValue='<%# Bind("FormaPagto") %>' Width="100%">
                                            ...
                                            <asp:ListItem Value="51" Text="Desconhecido" />
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left" Width="33%" />
                                </asp:TemplateField>
                        ...
                        <table width="100%" border='0'>
                            <tr>
                                <td valign="top" width="50%">
                                    ...
                                    <br />
                                    <table id="Table1" cellpadding="2" width="100%" runat="server" enableviewstate="false" visible="false">
                                        <tr>
                                            <td class="tdPrincipal1">
                        ...
                        <td style="border-top: solid 1px #507CD1" colspan="2" valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtVencimentoCob" BackColor="WhiteSmoke" Width="60px" SkinID="textboxSkin" runat="server" onkeypress="filtro_SoNumeros(event); mascara_DATA(this, event);" MaxLength="10" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" height="4">
