namespace www.reports
{
    ...
    public partial class controladoria : PageBase
    {
        ...
        void CarregaAgenda()
        {
            gridAgenda.DataSource = AgendaRelatorio.CarregarPorUsuario(Usuario.Autenticado.ID, AgendaRelatorio.eTipo.ControladoriaDetalhe);
            gridAgenda.DataBind();
        ...
        protected void cmdGerar_Click(Object sender, EventArgs e)
        {
            ...
            if (!chkAgendar.Checked)
            {
                ...
                String qry = AgendaRelatorio.ControladoriaDetalheQUERY(dtFrom, dtTo, oper, estp);
            ...
            else
            {
                ...
                obj.Tipo = (int)AgendaRelatorio.eTipo.ControladoriaDetalhe;
