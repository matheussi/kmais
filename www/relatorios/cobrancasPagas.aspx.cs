namespace www.relatorios
{
    ...
    public partial class cobrancasPagas : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                txtDe.Text = string.Concat("01/", DateTime.Now.Month, "/", DateTime.Now.Year);
        ...
        protected void cmdGerar_Click(Object sender, EventArgs e)
        {
            ...
            if (!chkAgendar.Checked)
            {
                ...
                String qry = AgendaRelatorio.CobrancasQUERY(dtFrom, dtTo, oper, estp);
            ...
            else
            {
                ...
                //obj.Tipo = (int)AgendaRelatorio.eTipo.CReceberPago;
