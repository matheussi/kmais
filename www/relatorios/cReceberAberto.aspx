<%@ Page Theme="Theme" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="false" CodeBehind="cReceberAberto.aspx.cs" Inherits="www.reports.cReceberAberto" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphTitle" runat="server">
    <table width="100%">
        <tr><td><span class="titulo">Relatório de contas a receber</span></td></tr>
    ...
    <asp:Panel runat="server" ID="pnl" Visible="false">
        ...
        <asp:GridView ID="grid" Width="100%" SkinID="gridViewSkin" runat="server" AllowPaging="false" AutoGenerateColumns="False" >
            <Columns>
                ...
                <asp:BoundField DataField="TipoBaixa" HeaderText="Baixa">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="Tipo_Boleto" HeaderText="Tipo">
                    <HeaderStyle HorizontalAlign="Left" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="contrato_superiorTerceiroCPF" HeaderText="Supervisor CPF">
                    <HeaderStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="usuario_nome" HeaderText="Produtor">
                    <HeaderStyle HorizontalAlign="Left" />
                ...
                <asp:BoundField DataField="usuario_documento1" HeaderText="Produtor CNPJ">
                    <HeaderStyle HorizontalAlign="Left" />
                </asp:BoundField>
