        ...
        <asp:Menu ID="mnuAdministracao" runat="server" Orientation="Horizontal">
            ...
            <Items>
                <asp:MenuItem Selectable="false" Text="Administração" Value="Administracao" >
                    ...
                    <%--<asp:MenuItem Text="Propostas" NavigateUrl="~/admin/admproposta.aspx" Value="AdmProp"></asp:MenuItem>--%>
                </asp:MenuItem>
            </Items>
        </asp:Menu>
    </div>
        ...
        <asp:Menu ID="mnuFinanceiro" runat="server" Orientation="Horizontal">
            ...
            <Items>
                <asp:MenuItem Selectable="false" Text="Financeiro" Value="Financeiro" >
                    ...
                    <asp:MenuItem Text="Cobranças não geradas" NavigateUrl="~/financeiro/cobrancaNaoGeradas.aspx" Value="CobNaoGer"></asp:MenuItem>
                    ...
                    <asp:MenuItem Text="Relatórios" Selectable="false" Value="Relatorios" Enabled="true">
                        <%--<asp:MenuItem Text="Comissionamento" NavigateUrl="~/financeiro/relatorios.aspx" Value="CobOpMan" />--%>
                        <asp:MenuItem Text="Cobranças" NavigateUrl="~/relatorios/cobrancasPagas.aspx" Value="relCobrancas" />
