<%@ Page Theme="Theme" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="false" CodeBehind="checklistLista.aspx.cs" Inherits="www.admin.checklistLista" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphTitle" runat="server">
    <table>
        <tr><td rowspan="3"></td></tr>
        <tr><td><span class="titulo">Checklist's para conferência de propostas</span></td></tr>
        <tr><td><span class="subtitulo">Abaixo os checklist's cadastrados no sistema</span></td></tr>
    </table>
</asp:Content>
