<%@ Page Theme="Theme" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="false" CodeBehind="statusMotivosAlteracao.aspx.cs" Inherits="www.admin.statusMotivosAlteracao" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphTitle" runat="server">
    <table>
        <tr><td rowspan="3"></td></tr>
        <tr><td><span class="titulo">Motivos de alteração de status de proposta</span></td></tr>
        ...
        <ContentTemplate>
            <asp:GridView ID="grid" Width="474px" SkinID="gridViewSkin" runat="server" AllowPaging="True" AutoGenerateColumns="False"  DataKeyNames="ID"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TipoTRADUZIDO" HeaderText="Evento">
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:BoundField>
