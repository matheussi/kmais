namespace www.admin
{
    ...
    public partial class checklistLista : PageBase
    {
        ...
        void CarregaLista()
        {
            ...
            grid.DataSource = CheckList.Carregar(operadoraId);
            grid.DataBind();
        }
        ...
        protected void grid_RowCommand(Object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect(String.Concat("~/admin/checklistDetalhe.aspx?", IDKey, "=", grid.DataKeys[Convert.ToInt32(e.CommandArgument)][0]));
            }
            else if (e.CommandName.Equals("excluir"))
            {
                try
                {
                    CheckList item = new CheckList(grid.DataKeys[Convert.ToInt32(e.CommandArgument)][0]);
                    item.Remover();
                    grid.PageIndex = 0;
                    this.CarregaLista();
                }
        ...
        {
            Response.Redirect("~/admin/checklistDetalhe.aspx");
        }
    }
}