...
var DD_belatedPNG = {
	...
	createVmlStyleSheet: function() { /* style VML, enable behaviors */
		...
		*/
		...
		//styleSheet.addRule(this.ns + '\\:*', '{behavior:url(#default#VML)}'); denis
	...
	**/
	fix: function(selector) {
		...
		for (var i=0; i<selectors.length; i++) {
			//this.styleSheet.addRule(selectors[i], 'behavior:expression(DD_belatedPNG.fixPng(this))'); /* seems to execute the function without adding it to the stylesheet - interesting... denis */
		}
	},
