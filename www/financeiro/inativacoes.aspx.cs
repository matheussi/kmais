namespace www.financeiro
{
    ...
    public partial class inativacoes : PageBase
    {
        ...
        void carregaMotivos()
        {
            ...
            cboStatusMotivo.DataSource = ContratoStatus.Carregar(ContratoStatus.eTipo.Inativacao);
            cboStatusMotivo.DataBind();
        }

        protected void cmdInativar_Click(Object sender, EventArgs e)
        {
            ...
            DateTime inativadoEm = base.CStringToDateTime(txtInativadoEm.Text);
            if (inativadoEm == DateTime.MinValue) { base.Alerta(null, this, "_err", "Data inválida."); txtInativadoEm.Focus(); return; }
            ...
            System.Collections.Hashtable ht = ContratoFacade.Instance.InativaContratos(numeros, cboOperadoras.SelectedValue, inativadoEm, faltaDePagtoEm, cboStatusMotivo.SelectedValue, txtObs.Text, Usuario.Autenticado.ID);
