<%@ Page Theme="Theme" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="false" CodeBehind="arquivoCobrancasConsulta.aspx.cs" Inherits="www.financeiro.arquivoCobrancasConsulta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    <asp:UpdatePanel runat="server" ID="up" UpdateMode="Always">
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="pnl" EnableViewState="false" Visible="false">
            <table width="390px" cellpadding="2" cellspacing="1" style="border: solid 1px #507CD1">
                <tr>
            ...
            <asp:Literal ID="litMsg" runat="server" EnableViewState="true" />
                <asp:GridView ID="gridResult" Width="100%" SkinID="gridViewSkin" 
                    runat="server" AllowPaging="false" AutoGenerateColumns="False" DataKeyNames="ID,ArquivoCobrancaID"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField Visible="true" DataField="ProcessamentoEm" HeaderText="Processado em" DataFormatString="{0:dd/MM/yyyy HH:mm}">
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField Visible="true" DataField="Origem" HeaderText="">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="1%" />
                        </asp:BoundField>
                        <asp:TemplateField>
                            <ItemStyle Width="1%" />
                            <ItemTemplate>
                                <asp:ImageButton CommandName="baixar" CommandArgument='<%# Container.DataItemIndex %>' ID="imbDownloadArquivo" AlternateText="Baixar arquivo CNAB" ToolTip="Baixar arquivo CNAB" ImageUrl="~/images/download.gif" runat="server" />
                            </ItemTemplate>
                         </asp:TemplateField>
                         ...
                         <asp:TemplateField>
                            <ItemStyle Width="1%" />
                            <ItemTemplate>
                                <asp:ImageButton CommandName="boletos" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ArquivoCobrancaID") %>' ID="imbBoletos" AlternateText="Boletos para impressão" ToolTip="Boletos para impressão" ImageUrl="~/images/duplicar.png" runat="server" />
                            </ItemTemplate>
                         </asp:TemplateField>
                         ...
                         <asp:TemplateField>
                            <ItemStyle Width="1%" />
                            <ItemTemplate>
                                <asp:ImageButton CommandName="xml" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ArquivoCobrancaID") %>' ID="imbDownloadXml" AlternateText="Exportar xml" ToolTip="Exportar xml" ImageUrl="~/images/xml-icon.png" runat="server" />
                            </ItemTemplate>
                         </asp:TemplateField>
                    </Columns>
                </asp:GridView>
